...
namespace ActiveDirectoryMicroservice.Controllers
{
    ...
    {
        private readonly ActiveDirectoryMicroserviceDbContext _context;
        private readonly IConfiguration _configuration;

        public AdminController(ActiveDirectoryMicroserviceDbContext context, IConfiguration configuration)
        {
            _context = context;
